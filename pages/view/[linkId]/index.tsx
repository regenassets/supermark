      ...
      return {
        props: {
          ...
          meta: {
            ...
            metaUrl: `https://www.supermark.cc/view/${linkId}`,
          },
      ...
      return (
        <>
          <CustomMetaTag
            ...
            title={
              meta.metaTitle ?? `${link?.document?.name} | Powered by Supermark`
            }
      ...
      return (
        <>
          <CustomMetaTag
            ...
            enableBranding={meta.enableCustomMetatag ?? false}
            title={
              meta.metaTitle ?? `${link?.dataroom?.name} | Powered by Supermark`
            }
            description={meta.metaDescription ?? null}
            imageUrl={meta.metaImage ?? null}
            url={meta.metaUrl ?? ""}
